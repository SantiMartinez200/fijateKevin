    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row d-flex align-items-center">
                        <label for="condicion_venta_id" class="col-md-4 col-form-label text-md-end text-start"><strong>¿Cómo se vende?:</strong></label> <!-- Agregar relacion -->
                        <div class="col-md-6" style="line-height: 35px;">
                    ...
                    <div class="row d-flex align-items-center">
                        <label for="aroma_id" class="col-md-4 col-form-label text-md-end text-start"><strong>Aroma:</strong></label> <!-- Agregar relacion -->
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $producto->aroma_id }}
                        </div>
                    </div>
